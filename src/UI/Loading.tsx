  ...
  return (
    <div
      className={ col ? pages
          ...
          : "gap-3 w-full h-48 md:h-112 border-2 border-indigo-600 bg-indigo-800/40 p-2 rounded-lg animate-pulse"
      }
    >
      {col ? (
        ...
        <div key={i} className={pages ? "w-full" : "w-28 md:w-52 shrink-0"}>
          <Skeleton
            ...
            className={` bg-indigo-800/40
              ${
                pages
                  ? "w-full h-48 sm:h-72 border-2 border-indigo-600 p-2 rounded-2xl"
                  : "h-44 md:h-72 border-2 border-indigo-600 p-2 rounded-2xl"
              }`}
          />
        </div>
